...
def extract_atari():
    font_bytes = extract_bytes('atari_rev10.rom', 0x2000, 128 * 8)
    out_data = [0]*(0x100 * 8)
    out_data[0x20 * 8 : 0x60 * 8] = font_bytes[0x00 * 8 : 0x40 * 8] # !@#..123...ABC...
    out_data[0x60 * 8 : 0x80 * 8] = font_bytes[0x60 * 8 : 0x80 * 8] # abcdef...
    out_data[0x80 * 8 : 0xA0 * 8] = font_bytes[0x40 * 8 : 0x60 * 8] # pseudo graphics
    return out_data
...
# this is the Atari font used in the 'debugtext-userfont-sapp' font sample
# print_c_array('ATARI', '_sdtx_font_atari', extract_atari())
