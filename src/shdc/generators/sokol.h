...
protected:
    ...
    virtual void gen_attr_slot_refl_func(const GenInput& gen, const Program& prog);
    virtual void gen_image_slot_refl_func(const GenInput& gen, const Program& prog);
    virtual void gen_sampler_slot_refl_func(const GenInput& gen, const Program& progm);
    virtual void gen_uniformblock_slot_refl_func(const GenInput& gen, const Program& prog);
    virtual void gen_uniformblock_size_refl_func(const GenInput& gen, const Program& prog);
    ...
    virtual std::string vertex_attr_name(const std::string& snippet_name, const refl::VertexAttr& attr);
    ...
    virtual std::string vertex_attr_definition(const std::string& snippet_name, const refl::VertexAttr& attr);
