...
protected:
    ...
    virtual std::string to_struct_name(const std::string& name);
    virtual std::string to_vertex_attr_name(const std::string& snippet_name, const refl::VertexAttr& attr);
    virtual std::string to_image_bind_slot_name(const refl::Image& img);
    virtual std::string to_sampler_bind_slot_name(const refl::Sampler& smp);
    virtual std::string to_uniform_block_bind_slot_name(const refl::UniformBlock& ub);
    virtual std::string to_vertex_attr_definition(const std::string& snippet_name, const refl::VertexAttr& attr);
    virtual std::string to_image_bind_slot_definition(const refl::Image& img);
    virtual std::string to_sampler_bind_slot_definition(const refl::Sampler& smp);
    virtual std::string to_uniform_block_bind_slot_definition(const refl::UniformBlock& ub);
};
