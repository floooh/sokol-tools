...
static bool cc(const std::string& src_path, const std::string& out_dia, const std::string& out_air, slang_t::type_t slang, std::string& output) {
    std::string cmdline;
