...
static void write_common_decls(Slang::type_t slang, const Args& args, const Input& inp, const spirvcross_t& spirvcross) {
...
static void write_attr_slot_func(const Program& prog, const Args& args, const Input& inp, const spirvcross_t& spirvcross) {
    const SpirvcrossSource* vs_src = find_spirvcross_source_by_shader_name(prog.vs_name, inp, spirvcross);
    assert(vs_src);
...
static void write_image_slot_func(const Program& prog, const Args& args, const Input& inp, const spirvcross_t& spirvcross) {
    const SpirvcrossSource* vs_src = find_spirvcross_source_by_shader_name(prog.vs_name, inp, spirvcross);
    const SpirvcrossSource* fs_src = find_spirvcross_source_by_shader_name(prog.fs_name, inp, spirvcross);
    assert(vs_src && fs_src);
...
static void write_sampler_slot_func(const Program& prog, const Args& args, const Input& inp, const spirvcross_t& spirvcross) {
    const SpirvcrossSource* vs_src = find_spirvcross_source_by_shader_name(prog.vs_name, inp, spirvcross);
    const SpirvcrossSource* fs_src = find_spirvcross_source_by_shader_name(prog.fs_name, inp, spirvcross);
    assert(vs_src && fs_src);
...
static void write_uniformblock_slot_func(const Program& prog, const Args& args, const Input& inp, const spirvcross_t& spirvcross) {
    const SpirvcrossSource* vs_src = find_spirvcross_source_by_shader_name(prog.vs_name, inp, spirvcross);
    const SpirvcrossSource* fs_src = find_spirvcross_source_by_shader_name(prog.fs_name, inp, spirvcross);
    assert(vs_src && fs_src);
...
static void write_uniformblock_size_func(const Program& prog, const Args& args, const Input& inp, const spirvcross_t& spirvcross) {
    const SpirvcrossSource* vs_src = find_spirvcross_source_by_shader_name(prog.vs_name, inp, spirvcross);
    const SpirvcrossSource* fs_src = find_spirvcross_source_by_shader_name(prog.fs_name, inp, spirvcross);
    assert(vs_src && fs_src);
...
static void write_uniform_offset_func(const Program& prog, const Args& args, const Input& inp, const spirvcross_t& spirvcross) {
    const SpirvcrossSource* vs_src = find_spirvcross_source_by_shader_name(prog.vs_name, inp, spirvcross);
    const SpirvcrossSource* fs_src = find_spirvcross_source_by_shader_name(prog.fs_name, inp, spirvcross);
    assert(vs_src && fs_src);
...
static void write_uniform_desc_func(const Program& prog, const Args& args, const Input& inp, const spirvcross_t& spirvcross) {
    const SpirvcrossSource* vs_src = find_spirvcross_source_by_shader_name(prog.vs_name, inp, spirvcross);
    const SpirvcrossSource* fs_src = find_spirvcross_source_by_shader_name(prog.fs_name, inp, spirvcross);
    assert(vs_src && fs_src);
